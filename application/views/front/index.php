                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <p>Parce que nous ne sommes pas toutes des cordons bleus, voici 10 trucs et astuces de cuisine pour maîtriser les bases de bons petits plats ... </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <h5><a href="#">6 façons de préparer le petit déjeuner pour 30</a></h5>
                            <p>Dressez la table du petit déj la veille, en prenant soin de déjà mettre la cuillère de chocolat et le sucre au fond des tasses, le sachet de ...</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <p>Mangez peu (maximum 500 g par semaine) de viande rouge, comme du bœuf, du veau, du porc et de l'agneau. Ne consommez pas de viande ayant subi une transformation ... </p>
                        </div>
                    </div>
                </div>
            </div>
